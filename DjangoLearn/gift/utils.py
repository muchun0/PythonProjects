...
# 使用hashlib中的md5类将字符串处理成MD5摘要的函数
...
class Captcha():
    ...
    def __init__(self, width, height, fonts=None, color=None):
        self._image = None
        # 字体路径
        self._fonts = fonts if fonts else [os.path.join(os.path.dirname(__file__), 'static/fonts', font)
         # 字体名称
    ...
    def _rotate(image, angle=25):
        ...
        return image.rotate(random.uniform(-angle, angle),
                            Image.Resampling.BILINEAR, expand=1)
